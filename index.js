...
//      channel.send('Grab the Wines!!');
     channel.send("Enjoy y'alls weekend, I know I will!!!💃🍻");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/3oEduZ8iYwB5GHIFDq/giphy.gif")
    });
