...
client.once("ready", () => {
  console.log(`Online as ${client.user.tag}`);
     ...
     channel.send("👾Pasa dushi wikènt!!👾");
     channel.send("https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdDF4bGdnMTNlZWcxNW9hN3A0YXZ4MHZoaGJyYm8wMnZ0bHl6NnJvMyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/sTczweWUTxLqg/giphy.gif")},
          null,true,
          "Europe/Amsterdam");
