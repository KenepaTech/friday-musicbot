...
//      channel.send('Grab the Wines!!');
    // channel.send("Time to relax em tiddies💃🥂");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/kfXKerAin4UauE9ZEA/giphy-downsized-large.gif")
    });
