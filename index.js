...
//      channel.send('Grab the Wines!!');
     channel.send("Have a good weekend y'all!🥂💃");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/fw2caEoXBisMJwksAu/giphy-downsized-large.gif")
    });
