...
//      channel.send('Grab the Wines!!');
     channel.send("Time to twerk💃 Have a good weekend y'all!🥂");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/POZAVqMVRAmjY7jh4L/giphy.gif")
    });
