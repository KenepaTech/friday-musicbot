...
//      channel.send('Grab the Wines!!');
     channel.send("Have a good weekend!!🥂");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/AOgwrHx4o49v2ZisoR/giphy-downsized-large.gif")
    });
