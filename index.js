...
//      channel.send('Grab the Wines!!');
     channel.send("Party time! Felis wikènt cabrones🤪");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif")
    });
