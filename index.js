...
client.once("ready", () => {
  console.log(`Online as ${client.user.tag}`);
     ...
     channel.send("Enjoy the warm (ish) weekend ahead 🌞🍻");
     channel.send("https://media0.giphy.com/media/8DWUNsTqg1zpArGbWp/giphy.gif?cid=ecf05e473q1jdr3qq83m7ou5txmq805gsf9b444x0pgz91b1&rid=giphy.gif&ct=g")},
          null,true,
          "Europe/Amsterdam");
