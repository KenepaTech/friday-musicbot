...
//      channel.send('Grab the Wines!!');
     channel.send("Splish splashing into the weekend!☔");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/RBTyWNVPdSTQeiZGwv/giphy.gif")
    });
