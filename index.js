...
//      channel.send('Grab the Wines!!');
     channel.send("Felis wikènt mi gente!!🥂");
     client.channels.cache.get("579799154449186868").send("https://media.giphy.com/media/zVXZzFxqdh5xEVZySs/giphy-downsized-large.gif")
    });
